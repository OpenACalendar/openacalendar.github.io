...
Version 1.3.1 is released, with some small improvements and an important bug fix. Details of the changes [are here](http://ican.openacalendar.org/release/1.3.1.html).
